...
@ControllerAdvice
public class SalonServiceApplicationException {
    ...
    @ExceptionHandler(value = SalonNotFoundException.class)
    public ResponseEntity<ExceptionResponse> salonNotFoundException(SalonNotFoundException ex){
